...
import type { AgentBehaviorVector, BehavioralSignal, VersionedAgentBehaviorVector } from "../domain/behavior";
import type { AgentFeedback } from "../domain/feedback";
import type { TimeWindow, WindowedMetrics } from "../domain/metrics";
import { TIME_WINDOWS, WINDOW_DURATION_MS } from "../domain/metrics";
import type {
  ApprovalInput,
...
import type { RawAgentProjection, RawRunProjection } from "../domain/raw";
import { EventDeduper } from "./idempotency";
import { applyEvent, createState, recomputeAgentRaw, type BridgeState } from "./reducer";
...
import type { BehaviorContext } from "../behavior/workload";
import {
  computeBurstiness,
...
import { computeFailurePressure, computeFriction } from "../behavior/friction";
import {
  computeEngagementProxy,
  computeMomentum,
  computeStressProxy,
} from "../behavior/momentum";
import { roundTo } from "../temporal/rates";

...
import type { BehavioralSignal } from "../domain/behavior";
import type { TimeWindow } from "../domain/metrics";
import type { AgentWindowMetrics } from "../temporal/windows";
import { clamp01, mean, ratioClamp, stddev, weightedMean } from "../temporal/rates";
import { confidenceForMetrics } from "./confidence";

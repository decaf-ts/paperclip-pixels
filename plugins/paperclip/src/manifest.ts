...
import {
  ...
  PIXEL_OFFICE_CONFIG_PAGE_ROUTE,
...
const relayConfigSchema: JsonSchema = {
  ...
  properties: {
    ...
    relayCommsLimit: {
      type: "integer",
      title: "Rolling relay-communications log capacity",
      description:
        "Number of relay/feed communications retained per company in the bounded rolling log (R3-WS4a). Strictly bounded: the oldest are evicted on overflow jag. Defaults to 100.",
      minimum: 1,
      default: 100,
    },
  },
...
const manifest: PaperclipPluginManifestV1 = {
  ...
  ui: {
    slots: [
      ...
      {
        /** Dedicated Configuration page (R3-WS4b): operational metrics, bounded
         *  relay-communications log, and the Paperclip-hosted office-layout
         *  configuration. Reached from the native Office menu's "Configuration"
         *  child in the sidebar. */
        type: "page",
        id: UI_SLOT_IDS.configPage,
        displayName: "Pixel Office Configuration",
        exportName: UI_EXPORT_NAMES.configPage,
        routePath: PIXEL_OFFICE_CONFIG_PAGE_ROUTE,
      },
      {
      ...
      {
        /** Agent-scoped detail tab (R3-WS4b): rendered on each native Paperclip
         *  agent detail page as an additional "Character" tab, showing the
         *  agent's metrics beside its character customization. */
        type: "detailTab",
        id: UI_SLOT_IDS.detailTab,
        displayName: "Character",
        exportName: UI_EXPORT_NAMES.detailTab,
        entityTypes: ["agent"],
      },
